...
export function AccountRail({
  ...
  /** The add-account form, given a way to close itself. No form, no Add button. */
  renderAddForm?: (close: () => void) => ReactNode
}): JSX.Element {
      ...
      >
        ...
        {renderAddForm && (
          <div className="border-t border-hairline p-2">
            {adding ? (
              <div className="w-[204px]">{renderAddForm(() => setAdding(false))}</div>
            ) : (
              <button
