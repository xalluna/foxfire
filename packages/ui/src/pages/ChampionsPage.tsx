...
export interface ChampionsPageProps {
  /** Null once loaded means there was nothing to show at all. */
  stats: ChampionStats[] | null | undefined
  loading: boolean
  queueId: number | null
  onQueueChange: (queueId: number | null) => void
  range: RankRange
  rangeOptions: Array<[RankRange, string]>
...
export function ChampionsPage({
  ...
  const selectedSeason = seasonLabel === null ? null : { label: seasonLabel }
