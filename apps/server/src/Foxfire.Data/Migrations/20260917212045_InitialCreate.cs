        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceLabel = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TagLine = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
                    Platform = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
                    RegionalRoute = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
                    SummonerId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RiotAccounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RiotAccounts_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RiotAccounts_GameName_TagLine",
                table: "RiotAccounts",
                columns: new[] { "GameName", "TagLine" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RiotAccounts_OwnerId",
                table: "RiotAccounts",
                column: "OwnerId");
